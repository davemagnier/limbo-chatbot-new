...
export default function TestnetPage() {
    ...
    const {
        ...
        queryFn: async () => {
            const { nextClaimIn, error, response } = await fetchCooldown(
                session
            );
    ...
    const { mutate: faucetClaim, isPending: isFaucetClaimPending } =
        useMutation({
            mutationFn: async () => {
                if (!session) return;
                        ...
                        >
                            <div className="onboarding-header">
                                ...
                                <p className="onboarding-subtitle">
                                    Experience the future of decentralized
                                    interactions. Test our chain, collect
                                    badges, and explore with Limbo.
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div className="checkbox-container">
                                ...
                                <div className="checkbox-label">
                                    ...
                                    and understand that testnet tokens have no
                                    real value.
                                </div>
                            </div>
                ...
                <div className="extension-modal-content">
                    ...
                    <div className="extension-modal-body">
                        <div className="extension-description">
                            <p>
                                Mint AI chat conversations directly to
                                blockchain from any AI chat interface!
                            </p>
                            <p className="browser-note">
                                Works with browser-based AI chats only (ChatGPT,
                                Claude, etc.)
                            </p>
                        ...
                        <div className="installation-steps">
                            ...
                            <div className="step-card">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>
                                        Click below to download the extension
                                        files
                                    </p>
                                    <button
                            ...
                            <div className="step-card">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>
                                        Go to Chrome settings or type in address
                                        bar:
                                    </p>
                            ...
                            <div className="step-card">
                                ...
                                <div className="step-content">
                                    ...
                                    <p>
                                        Toggle the "Developer mode" switch in
                                        the top right
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="step-card">
                                ...
                                <div className="step-content">
                                    <h4>Start Minting!</h4>
                                    <p>
                                        Visit any browser-based AI chat
                                        (ChatGPT, Claude, etc.) and you'll see
                                        "Mint to Chain" buttons on AI responses
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="extension-footer">
                            <p className="help-text">
                                Need help? The extension adds "Mint to Chain"
                                buttons to AI chat messages
                            </p>
                            <button
                                className="action-button primary"
                                onClick={downloadExtension}
                ...
                <div className="mints-modal-content">
                    ...
                    <div className="mints-modal-body" id="mintsModalBody">
                        <div className="auth-container" id="authContainer">
                            ...
                            <p>
                                Sign a message with your wallet to securely
                                access your minted conversations.
                            </p>
                            <button
                    ...
                    <div className="mints-modal" id="mintsModal">
                        <div className="mints-modal-content">
                            <div className="mints-modal-header">
                                ...
                                <button
                                    className="modal-close"
                                    onClick={closeMyMints}
                                >
                                    x
                                </button>
                            </div>
                            <div
                                className="mints-modal-body"
                                id="mintsModalBody"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <h3>Authenticate to View Your Mints</h3>
                                    <p>
                                        Sign a message with your wallet to
                                        securely access your minted
                                        conversations.
                                    </p>
                                    <button
                                        className="auth-button"
